...
def hierarchical_softmax_layer_for_sequence(input_var, num_output_classes, target_class, target_output_in_class, batch_size, w1, b1, w2s, b2s):
    ...
    Example:
        ...
        [array([[ 0.16448107],
                [ 0.00597861],
                [ 0.99322051]], dtype=float32), array([[  8.59128195e-04],
                [  3.77086673e-09],
                [  3.42400197e-12]], dtype=float32), array([[  9.99998212e-01],
                [  2.27011213e-07],
                [  1.46681407e-17]], dtype=float32), array([[  1.00738886e-21],
                [  1.00000000e+00],
                [  5.99326422e-11]], dtype=float32), array([[  4.88255412e-26],
                [  2.71541217e-31],
